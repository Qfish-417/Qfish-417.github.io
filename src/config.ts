...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://Qfish-417.github.io/"， // 请替换为你的站点URL，以斜杠结尾
	...
	bilibili: {
		vmid: "38336510689", // 在此处设置你的Bilibili用户ID (vmid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			title: "Qfish的逐火之旅", // 主页横幅主标题

			subtitle: [
				"愿此行，终抵群星！",
				"因为人们总要走向未来。纵使人性的弱点驻足停步，但在真正无法前行的时候，人类一定会试图拯救自己。",
				"只有当一个人绝意告别过去的时候，他才会坦然面对全部的自我。",
				"于刹那间溃堤的绝望，抵得上百十载的星霜流年。",
				"答案并不重要,重要的是从别人的答案里 我们自己能得到什么，是吗? ",
				"当你有机会做出选择的时候，不要让自己后悔……",
				"命运的齿轮或许要经历漫长的岁月才能转动，但这并不意味，我们要一味被动等待命运的安排",
				"倘若我们终将走向终末，也许终将没有未来，至少我们可以选择，带着光明一同前行。",
				"宁愿被遗忘，也不愿被定义。",
				"世间仍有许多美好值得我们为之一战",
				"你们从不是柴薪，你们才是火焰，是照亮这世界的光。而我，名为希望之火，实为希望之柴。点燃我，拿走这份光明，用世界最后的变化，为自己、为世界去争一份希望！",
			],
			typewriter: {
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Qfish-417",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/3494363625687234?spm_id_from=333.1007.0.0",
					external: true,
